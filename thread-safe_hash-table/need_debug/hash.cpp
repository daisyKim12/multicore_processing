...
Hash::Hash(int num_bucket) : BUCKET(num_bucket), mutex_num(4) {
...
void Hash::insertItem(string word)
{
    ...
    int mutex_table_index = index % mutex_num;
    // using index find which mutex to utilize
    //std::lock_guard<std::mutex> lock(mutex_table[mutex_table_index]);
